...
export default function Home() {
  return <main>
    ...
    <section className="work" id="work"><ScrollReveal><p className="kicker">01 / Selected work</p><h2>Useful, weird,<br />technically inconvenient.</h2></ScrollReveal><ScrollReveal className="reveal-delay"><div className="project-grid">
      ...
      <article className="project"><small>03 / ML systems</small><h3>Parag</h3><p>A research-to-product experiment in semantic compression and client-side chat models.</p><a href="https://cxaiiii.github.io/parag-chat" target="_blank">Try Parag-chat ↗</a></article>
      <article className="project"><small>04 / Edge systems</small><h3>Sanketa</h3><p>Semantic and lossless compression toward a physical off-grid mesh messenger.</p><span>Research in progress</span></article>
