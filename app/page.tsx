...
export default function Home() {
  return <main>
    ...
    <section className="work" id="work"><ScrollReveal><p className="kicker">01 / Selected work</p><h2>Useful, weird,<br />technically inconvenient.</h2></ScrollReveal><ScrollReveal className="reveal-delay"><div className="project-grid">
      ...
      <article className="project"><small>03 / ML systems · 0.8B param · multimodal · offline</small><h3>Parag</h3><p>A research-to-product experiment in semantic compression and client-side chat models.</p><span>Coming soon</span></article>
