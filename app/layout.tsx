...
export const metadata: Metadata = {
  ...
  description: 'Chaitanya Saxena builds products at the intersection of design, software, AI and hardware.',
  ...
  openGraph: { type: 'website', locale: 'en_IN', url: 'https://chaii.wtf', siteName: 'chaii.wtf', title: 'Chaitanya Saxena — Creative Technologist', description: 'I build things that shouldn’t exist yet.' },
